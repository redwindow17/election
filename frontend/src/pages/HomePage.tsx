    ...
    <div className="home">
      ...
      <section className="home__hero">
        <div className="home__hero-content">
          ...
          <div className="home__cta animate-fade-in-up delay-2">
            <Link to="/guide">
              <Button size="lg" variant="saffron" icon="🗳️">
      ...
      <section className="home__features container">
        ...
        <div className="home__feature-grid">
          <div className="glass-card home__feature-card animate-fade-in-up delay-1">
          ...
          <div className="glass-card home__feature-card animate-fade-in-up delay-2">
            <div className="home__feature-icon">🔒</div>
          ...
          <div className="glass-card home__feature-card animate-fade-in-up delay-3">
            <div className="home__feature-icon">🇮🇳</div>
